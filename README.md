...
Each platform directory is deploy-only -- it holds just the built
installer, nothing build-time (build scripts live in `_shared/`, see
`windows/README.md`'s "How a release is cut"). See
[`windows/README.md`](windows/README.md) for the full breakdown -- the
